            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 features-text">
                        ...
                        <p>
                            Your decision in marketing strategies might influence the progress of the whole company. The Challenging role will offer you a precious opportunity in researching for marketing models and put your ideas into practice. </p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="contactus" class="gray-section contact">
            <div class="container">
                ...
                <div class="row m-b-lg">
                    ...
                    <div class="col-lg-4">
                        <p class="text-color">
                            ClassGotcha is a growing educational tech start-up that provides a progressive solution to help college students to organize, communicate and share learning materials at one place. We won the EdTech Challenge in HackPSU 2016, sponsored by COIL and newly enrolled in LanchBox 2017 Spring cohort.
                        </p>
                    </div>
                </div>
