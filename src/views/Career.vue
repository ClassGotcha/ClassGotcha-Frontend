        ...
        <section id="contact" class="gray-section contact">
            <div class="container">
                ...
                <div class="row m-b-lg">
                    ...
                    <div class="col-lg-4">
                        <p class="text-color">
ClassGotcha is an online platform that helps college students to organize, communicate and share learning materials in one place. Unlike other learning management systems that’s required by university, we are focusing on students.
And We aggregate the information from multiple platforms, they don’t have to go back and forth among different system.
                        </p>
                    </div>
                </div>
                <div class="row">
